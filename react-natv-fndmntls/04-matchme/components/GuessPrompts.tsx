...
import { ActivityIndicator, Alert, FlatList, Modal, Platform, StyleSheet, Text, View } from "react-native"
...
export function GuessPrompts({ prompts }: GuessPromptsProps) {
  ...
  function onResetHandler() {
    ...
    if (Platform.OS === "web") {
      const confirmed = window.confirm("You're about to lose all your progress! Are you sure you want to continue?")
      if (confirmed) {
      ...
      Alert.alert("Resetting", "You're about to lose all your progress! Are you sure you want to continue?", [
      {
        text: "Back",
      },
      {
  ...
  return (
    <View style={globalStyles.grow}>
      <Modal visible={!!results || isLoadingResults} onRequestClose={() => setResults(undefined)} animationType="fade" transparent>
