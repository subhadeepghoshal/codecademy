      ...
      <KeyboardAvoidingView style={globalStyles.grow} behavior={Platform.OS === "ios"? "padding" : "height"}>
        <ScrollView style={globalStyles.grow}>
          <View style={[globalStyles.inputContainer, { gap: SPACING.sm}]}>
            { /* Task 1 and 2: Improve the accessibility of this Text and TextInput element */ }
            <Text testID="prompt-name-text-label" style={globalStyles.inputLabel}>Prompt:</Text>
            <TextInput
          ...
          <View style={[globalStyles.inputContainer, { gap: SPACING.sm}]}>
            { /* Task 1 and 2: Improve the accessibility of this Text and TextInput element */ }
            <Text testID="prompt-points-text-label" style={globalStyles.inputLabel}>Points:</Text>
            <TextInput
              style={[globalStyles.input, globalStyles.textInput]}
              value={promptPoints}
          ...
          <View style={globalStyles.inputContainer}>
            { /* Task 1 and 2: Improve the accessibility of this Text element */ }
            <Text testID="prompt-mood-text-label" style={globalStyles.inputLabel}>Mood:</Text>

            { /* Task 3: Improve the accessibility of this View element */ }
